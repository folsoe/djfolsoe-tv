  ...
  async fetch(request, env) {
    ...
    try {
      ...
      if (path === "/api/discovery-picks") {
        ...
        return saveList(request,env,core,"discoveryPicks");
      }
      if (path === "/api/top20") {
