...
function overlayState(core) {
  ...
  return {
    ...
    boxes:{
      ...
      status: {label:"LIVE STATUS",title:`${station.followers||870}/${station.followersGoal||1000} followers`,body:"folsoetv.dk online"},
...
function v8162MotionLanes(core, state){
  ...
  return {
    box1:[
      ...
      {label:"LIVE STATUS", headline:`${live.viewers||0} viewers`, body:"folsoetv.dk · Twitch Music TV", icon:"👁️"},
      {label:"GOALS", headline:"Help DJ FOLSOE grow", body:"Follow · Chat · Request · Share the love", icon:"💜"}
    ],
    box2:[
      {label:"PROGRAM", headline:show.title || state.show?.title || theme.title || "DJ FOLSOE LIVE", body:show.time || state.show?.description || theme.desc || "folsoetv.dk", icon:"📺"},
