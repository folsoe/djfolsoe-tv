...
function twitchBottomTicker(core){
  ...
  const items = [
    ...
    latestFollower ? "SENESTE FOLLOWER · " + latestFollower : "SENESTE FOLLOWER · TAK FOR AT FOLLOWE KANALEN",
    latestSub ? "SENESTE SUB · " + latestSub : "SENESTE SUB · TAK FOR STØTTEN",
    latestBits ? "SENESTE BITS · " + latestBits : "SENESTE BITS · TAK FOR SUPPORTEN",
    latestRaid ? "SENESTE RAID · " + latestRaid : "SENESTE RAID · DJ NETWORK LOVE",
