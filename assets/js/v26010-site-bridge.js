...
(() => {
  ...
  function apply(payload) {
    ...
    if (id) document.body.dataset.showTheme = id;
  ...
  function start() {
    ...
    window.DJF_V26010_SITE = { refresh, apply, status: () => ({ ready: true, build: BUILD, revision: lastRevision }) };
    console.info('DJ FOLSOE V26010 Safe Website CMS Bridge ready');
  }
